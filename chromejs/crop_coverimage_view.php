...
<body>
	...
	<img src="images/step2.png" style="margin-left:50px; float:left;margin-right:5px;"><span class="crop_heading" style="margin-top:5px;width:auto;float:left;">Select Mosaic Image</span>
...
<div class="clear"></div>
    <div class="pane clearfix" style="margin-top:15px;">
     ...
     <div class="crop_button" style="float:left;">
     ...
     <a href="#" style="text-decoration:none;cursor:pointer" >Choose another image</a>
		...
		<a href="#" style="text-decoration:none;" >Choose another image</a>
		<input onchange="upload_file1();" type="file" multiple="multiple" name="file" style="float: left;     height: 26px;     margin-left: -269px;     margin-top: 3px;     opacity: 0;     position: absolute;     width: 176px">
          ...
          <div style="float:right;width:300px;" class="crop_heading_a">Image dimension:990X272pixel</div>
			...
			<div style="float:left;width:1024px;margin-top:10px;margin-left:0px;">
				<div  class="crop_detail">
					To crop this image, drag the region below and then click "Set as cover photo".
				</div>
