...
<div>
 ...
 <table width="100%" height="100%" cellpadding="0" cellspacing="0" bgcolor="white" style="background-color:#fff;border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;" >
	...
	<h6 style="padding-left:10px; width:190px; margin-top:-34px;text-align:center;border-radius: 0 0 5px 5px;"><?php echo $row['user_firstname']." ".$row['user_lastname']?></h6>
 </div>
  ...
  <div id="tabs_wrapper">
	<div id="tabs_container">
		<ul id="tabs" style="width:450px; float:left;padding: 7px 0 4px 0;">
			<li class="active"><a href="#tab1"><?php echo $string;?></a></li>
	...
	<div id="tabs_content_container">
		<div id="tab1" class="tab_content" style="display: block;">
			<?php
  $sql59="select review_id, review_cat_id, review_opinion, review_rate from tbl_review where review_cat_id in (select cat_id from tbl_category where  cat_created_by=$user_id) order by review_id DESC limit 0,9";
  //echo $sql59;
