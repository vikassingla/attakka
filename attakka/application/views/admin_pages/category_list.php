					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>	
								...
								<td><h3><?php echo $site_data_detail['category_name'];?></h3></td>
								...
								<td>       <a href="category/category_image_list/<?php echo $site_data_detail["category_id"];?>" class="ico edit">Upload</a>                         </td>
                                <td>
                                <?php 
								if($site_data_detail['category_status']==0)
								{
								?>	
                                <a href="category/active_inactive/<?php echo $site_data_detail['category_id'];?>/1"title="Active">Active</a>
                                <?php
								}
								
								if($site_data_detail['category_status']==1)
								{
								?>
                                <a href="category/active_inactive/<?php echo $site_data_detail['category_id'];?>/0" >Inactive</a>
                                <?php
								}?>
                                
                                
                                	<a href="category/edit_category/<?php echo $site_data_detail["category_id"];?>" class="ico edit">Edit</a>
                                </td>
							</tr>
