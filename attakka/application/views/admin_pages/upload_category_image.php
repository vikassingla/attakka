...
$(document).ready(function() {
	...
	$("#file_upload").uploadify({
		...
		'script': '<?php echo base_url(); ?>/category/move_file_on_server',
		...
		'onComplete': function(event, ID, fileObj, response, data) {
			...
			$.post("<?php echo base_url(); ?>/category/upload_insert", { name: fileObj.name , category_id:category_id }, function(info) {
...
<br/>
<h2>Upload image for the category:  <?php echo $category_detail['category_name']; ?></h2><br/>
...
&nbsp;&nbsp;&nbsp;<a href="category/category_image_list/<?php echo $category_id;?>">After upload view image</a>
</div>
<br/><br/>
</form>
