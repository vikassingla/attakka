...
<div id="container">
	<div class="shell">		
		...
		<div id="main">
            ...
            <div  align="center">
			<h2>	<?php echo $user_full_name ;?> send message detail </h2><br/>
            </div>     
            <br/>
				<!-- Box -->
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Send Message Detail </h2>
            ...
            <td><h3><strong>To email:</strong>:</h3></td>                                						
            <td><h3><?php echo $message_detail['to_email'];?></h3></td>
