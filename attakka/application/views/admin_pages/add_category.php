                    ...
                    <input type="hidden" name="operation"  value="add_category">
						...
						<div class="form">
								<p>									
									...
									<input type="text" class="field size1" name="category_name" id="category_name"  value="<?php echo $this->input->post('category_name');?>"/>
								</p>	
                                ...
                                <p>
									...
									<textarea class="field size1" rows="10" cols="30" name="category_description" id="category_description"><?php echo $this->input->post('category_description');?></textarea>
								</p>
                                
                                 <p>
									
									<label>Category Rules </label>
									<textarea class="field size1" rows="10" cols="30" name="category_rules" id="category_rules"><?php echo $this->input->post('category_rules');?></textarea>
								</p>
