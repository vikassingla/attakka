...
<div class="red-color-heading">Reply a <span class="black-color-heading">Message</span>
...
<div class="inputpanel-right"><input readonly="readonly" value="<?php echo $sender_info['user_email'];?>" type="text" class="input" name="to_email" style="width:275px;" />
