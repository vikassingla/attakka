...
<div class="red-color-heading">Create a <span class="black-color-heading">Subcategory</span>
...
<div class="inputpanel-rightCategory">
  ...
  <select   class="input" style="width:200px;" name="category_id">
...
<div class="inputpanel-right"><input value="<?php echo $this->input->post('sub_category_name');?>" type="text" class="input" name="sub_category_name" style="width:275px;" />
...
<div class="inputpanel-rightCategory">
  <select   class="input" style="width:200px;" name="sub_category_type">
    <option value="1" <?php if($this->input->post('sub_category_type')==1) {?> selected="selected" <?php } ?>>Regional</option>
     <option value="2" <?php if($this->input->post('sub_category_type')==2) {?> selected="selected" <?php } ?>>Globla</option>
  </select>
</div>
<div class="clear"></div>
...
<div class="form-text" style="float:left;">Do you want to aply for Moderator (MOD)?   </div><yes-button-form-new" style="margin-left:40px;"><input type="radio"  <?php if($this->input->post('apply_moderator')==1) {?>  checked="checked" <?php } ?> value="1" name="apply_moderator">Yes <input type="radio" name="apply_moderator" value="0" <?php if($this->input->post('apply_moderator')==0) {?>  checked="checked" <?php } ?>>No
<div class="clear"></div>
...
<div id="right-panelform"><div class="formpanel-text-right form-text">Description:</div>
  <div class="inputpanel-right2"> <textarea name="sub_category_description" rows="3" class="textarea" style="width:270px;"><?php echo $this->input->post('sub_category_description');?></textarea> 
  ...
  <div class="inputpanel-right2"> <textarea name="sub_category_rules" rows="1" class="textarea" style="width:270px;"><?php echo $this->input->post('sub_category_rules');?></textarea>  
