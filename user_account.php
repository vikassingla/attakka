...
<title>ATTAKKA -My Account Picture</title>
...
<div class="red-color-heading"><span>Account Picture</span></div>
<div class="clear"></div>
<div id="upload_status" style="font-size:12px; width:80%; margin:10px; padding:5px; display:none; border:1px #999 dotted; background:#eee;"></div>
	...
	<span id="loader" style="display:none;"><img src="front-end/images/loader.gif" alt="Loading..."/></span> <span id="progress"></span>
	<br />
