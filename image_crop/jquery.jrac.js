  ...
  $.fn.jrac = function(options) {
    ...
    return this.each(function() {
      ...
      var image_load_handler = function(){
        ...
        if (!jrac_loaded) {
          var $zoom_widget = $('<div class="jrac_zoom_slider"><div class="ui-slider-handle"></div><div><input type="button" name="zoom_in" id="zoom_in" value="+"/></div></div>')
